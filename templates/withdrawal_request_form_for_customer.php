<div class="wrap" >
    ...
    <form method="post">
        مبلغ
        <br>
        (حداقل<?php  echo wMyWallet_Options::get('withdrawal-min') . ' ' . wMyWallet_get_currency_symbol(); ?>)<input name="amount" type="text" value="<?php echo isset($_POST['amount']) ? $_POST['amount'] : ''; ?>">
        ...
        <br>
        <br>
        <button type="submit" name="submit" class="button button-primary" >درخواست برداشت</button>
    </form>
